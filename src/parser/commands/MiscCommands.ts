  ...
  definitions: CommandDefinition[] = [
    {
      ...
      commandType: CommandType.INSTALL_DYLIB,
      patterns: [
    ...
    {
      command: 'open url',
      commandType: CommandType.OPEN_URL,
      patterns: [
    ...
    },
    {
      ...
      commandType: CommandType.CLEAR_KEYCHAIN,
      patterns: [
    ...
    },
    {
      ...
      commandType: CommandType.SET_LOCATION,
      patterns: [
    ...
    {
      command: 'add media',
      commandType: CommandType.ADD_MEDIA,
      patterns: [
      ...
      parameterTypes: {
        mediaPaths: 'string-array',
        sessionId: 'string',
      },
    },
    {
      command: 'approve permissions',
      commandType: CommandType.APPROVE_PERMISSIONS,
      patterns: [
    ...
    },
    {
      ...
      commandType: CommandType.UPDATE_CONTACTS,
      patterns: [
